...
function LandingPage({ setCurrentPage }) {
        ...
        .insert([
          {
            ...
            type_client: "particulier", // ← par défaut particulier
          },
        ])
        .select();
  ...
  const faqItems = [
    {
      ...
      answer:
        "Nous proposons : ménage, repassage, courses, diététique et aide au repas. Chaque service est adapté à vos besoins.",
    },
    {
      question: "Combien ça coûte ?",
      answer:
        "Les tarifs dépendent des services choisis. Contactez-nous pour un devis personnalisé !",
    },
    {
      question: "Êtes-vous disponible le week-end ?",
      answer:
        "Nous étudions chaque demande. Appelez-nous au numéro d'urgence pour en discuter.",
    },
    {
      question: "Comment annuler un service ?",
      answer:
        "Vous pouvez annuler en nous contactant. Les conditions d'annulation dépendent de votre abonnement.",
    },
  ];
  ...
  const engagements = [
    {
      ...
      title: "Produits BIO",
      description:
        "Nous utilisons uniquement des produits écologiques et naturels pour nettoyer votre maison. Zéro chimie agressive, 100% nature.",
    },
    {
      icon: "♻️",
      title: "Éco-responsable",
      description:
        "Réduction des déchets, produits biodégradables, respect de l'environnement. Prendre soin de votre maison c'est aussi prendre soin de la planète.",
    },
    {
      icon: "🛡️",
      title: "Hygiène Garantie",
      description:
        "Normes strictes de nettoyage et d'hygiène. Vos espaces sont traités avec la plus grande rigueur pour votre santé.",
    },
  ];
  ...
  return (
    <div className="bg-white">
      ...
      <header
        className={`bg-gradient-to-r from-orange-50 to-yellow-50 shadow-lg sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "py-1 md:py-1" : "py-1 md:py-2"}`}
      >
        <div className="max-w-7xl mx-auto px-2 md:px-4">
          <div className="flex justify-between items-center gap-2 md:gap-8">
            ...
            <div className="flex-grow text-center">
              <h1
                className={`font-bold mb-2 md:mb-3 transition-all duration-300 ${
                  isScrolled
              ...
              <p
                className={`font-bold text-gray-800 mb-1 md:mb-2 transition-all duration-300 ${
                  isScrolled
              ...
              <p
                className={`text-gray-700 font-semibold mb-2 md:mb-4 transition-all duration-300 ${
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-700 mb-8">
                ...
                <strong>Chacun mérite d'être bien chez soi.</strong> Nous nous
                occupons de tout.
              </p>
              <p className="text-gray-600 mb-8 text-lg">
                "Même une pantoufle moche a sa place dans la maison" - Chez nous
                aussi, chacun a sa place.
              </p>
              <a
                href="#formulaire"
                className="inline-block bg-gradient-to-r from-orange-400 to-pink-500 text-white font-bold py-4 px-8 rounded-xl hover:from-orange-500 hover:to-pink-600 transition transform hover:scale-105 text-lg"
              >
                ➕ Je m'abonne
              </a>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {services.slice(0, 3).map((service, idx) => (
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-2xl hover:shadow-xl transition transform hover:scale-105"
              >
      ...
      <section className="bg-gradient-to-r from-red-500 to-red-600 py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <a
            href="tel:+33XXX"
            className="text-4xl font-bold text-white hover:text-gray-100 transition"
          >
            📞 +33 X XX XX XX XX
          </a>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {serviceDetails.map((service, idx) => (
                <div
                  key={idx}
                  className="border-2 border-purple-200 rounded-xl p-6 hover:border-purple-600 transition"
                >
                  <h5 className="text-xl font-bold text-purple-600 mb-4">
                    {service.name}
                  </h5>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Nous comprenons vos besoins. Chacun mérite respect et
                bienveillance. Nous ne sommes pas juste des prestataires, nous
                sommes vos alliés.
              </p>
            </div>
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                Services professionnels, fiables et adaptés à VOS besoins. Nous
                ne sommes pas une usine, c'est du sur-mesure.
              </p>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                Pas de grandes multinationales froides, juste du vrai soutien.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-700 mb-6">
                Vous êtes passionné(e) par le service aux personnes ? Vous
                cherchez une activité flexible avec du sens ?
              </p>
              <ul className="space-y-3 mb-8 text-lg text-gray-700">
                <li>
                  ✅ <strong>Horaires flexibles</strong> - Travaillez quand vous
                  voulez
                </li>
                <li>
                  ✅ <strong>Travail dignifié</strong> - Respect et
                  bienveillance garantis
                </li>
                <li>
                  ✅ <strong>Rémunération juste</strong> - Transparence totale
                </li>
                <li>
                  ✅ <strong>Équipe sympathique</strong> - Vous n'êtes pas
                  seul(e)
                </li>
              </ul>
              <button
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, idx) => (
              <div
                key={idx}
                className="bg-white p-8 rounded-2xl border-2 border-purple-200 shadow-lg"
              >
      ...
      >
        <div className="max-w-2xl mx-auto px-4">
          ...
          <form
            ...
            className="bg-white rounded-3xl shadow-2xl p-10 border-4 border-orange-300 relative"
          >
            ...
            <div className="space-y-6 mt-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <label
                      key={service}
                      className="flex items-center gap-3 cursor-pointer p-3 rounded-lg hover:bg-purple-100 transition"
                    >
                      <input
                        type="checkbox"
              ...
              <div>
                <label className="block text-gray-800 font-bold mb-3 text-lg">
                  💭 Vos souhaits, préférences, doléances (max 200 caractères)
                </label>
                <textarea
                  name="souhaits"
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      souhaits: e.target.value.slice(0, 200),
                    })
                  }
                  maxLength="200"
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {faqItems.map((item, idx) => (
              <div
                key={idx}
                className="border-2 border-gray-300 rounded-2xl overflow-hidden hover:border-purple-600 transition"
              >
                <button
                  onClick={() =>
                ...
                >
                  <span className="font-bold text-gray-800 text-lg text-left">
                    {item.question}
                  </span>
                  <ChevronDown
                    size={24}
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">
            ...
            Elles ne seront jamais vendues à des tiers. Vous pouvez demander la
